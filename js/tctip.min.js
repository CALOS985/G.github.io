var tctipUtil = {
        ...
        getElementsByClassName: function (d, c) {
            return c = c || document, c.getElementsByClassName ? c.getElementsByClassName(d) : function (o, e) {
                var p, q, i = [],
    ...
    tctip = window.tctip || {
        ...
        generateMyConfig: function () {
            ...
            0 == j && (i[0].className = "myR-on"), tctip.myConfig.list = i
        },
        generateMyRewards: function () {
            ...
            }), this.generateLeftBtn(), this.generateMyRewardsMain()
        },
        generateLeftBtn: function () {
            var b = {
                className: "btn-myRewards"
            };
            b.style = "margin-top:" + tctip.myConfig.siderTextTop + ";", b.onmouseover = function () {
                tctip.showTctip(this)
            }, this.myRewardsBtn = tctipUtil.createElement(b, "a", this.myRewards);
            b = {
                className: "sider-text"
            };
            b.style = "background-color:" + tctip.myConfig.siderBgcolor, b[tctipUtil.getTextKey()] = tctip.myConfig.siderText, tctipUtil.createElement(b, "p", this.myRewardsBtn)
        },
        ...
        generateMyRewardsMain: function () {
            ...
            f[tctipUtil.getTextKey()] = ">>", tctipUtil.createElement(f, "a", this.myRewardsMain);
            f = {
                className: "myR-h"
            };
            f[tctipUtil.getTextKey()] = tctip.myConfig.headText, tctipUtil.createElement(f, "h1", this.myRewardsMain), this.generateMyRewardsbox();
        ...
        generateMyRewardsbox: function () {
            ...
            }, "div", this.myRewardsMain), this.generateMyRewardsList(), this.generateMyRewardsDetail()
        },
        generateMyRewardsList: function () {
            this.myRewardsList = tctipUtil.createElement({
                className: "myRewards-list"
            }, "div", this.myRewardsbox), tctip.myConfig.list.length >= 5 ? this.myRewardsListUl = tctipUtil.createElement({}, "ul", this.myRewardsList) : this.myRewardsListUl = tctipUtil.createElement({
                className: "not-full"
            ...
            for (var g = 0; g < 5 && tctip.myConfig.list.hasOwnProperty(g); g++) {
                ...
                (function () {
                    ...
                    c[tctipUtil.getTextKey()] = e.name, 4 == g && (c.className = "fifth"), a = tctipUtil.createElement(c, "a", h)
                })(), "myR-on" == e.className && (this.currentLi = h, this.currentData = e), tctipUtil.createElement({
                    className: "png",
                    src: e.icon,
                    alt: e.name
                }, "img", a)
        ...
        generateMyRewardsDetail: function () {
            tctip.myRewardsDetail && tctip.myRewardsbox.removeChild(tctip.myRewardsDetail), this.myRewardsDetail = tctipUtil.createElement({
                className: "myRewards-detail"
            }, "div", this.myRewardsbox), this.myRewardsUbox = tctipUtil.createElement({
            ...
            if (tctip.currentData.hasOwnProperty("text")) {
                ...
                d[tctipUtil.getTextKey()] = "扫描二维码支持卡洛斯", tctipUtil.createElement(d, "p", this.myRewardsUbox);
        ...
        leftMouseover: function (d, c) {
            tctip.currentLi.className = "", d.parentNode.className = "myR-on", tctip.currentLi = d.parentNode, tctip.currentData = c, tctip.generateMyRewardsDetail()
        },
        init: function () {
